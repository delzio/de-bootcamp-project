...
from dag_functions import pls_prediction_to_bq

current_time = datetime.fromisoformat(args.current_time)
pls_prediction_to_bq(gcs_bucket=args.gcs_bucket, dataset=args.dataset, gcs_raw_path=args.gcs_raw_path, project_id=args.project_id, pls_model_path=args.pls_model_path, current_time=current_time)